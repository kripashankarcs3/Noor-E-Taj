          ...
          <div style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 'var(--radius-lg)', padding: '20px', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <div style={{ marginBottom: '12px', paddingBottom: '12px', borderBottom: '1px solid var(--card-border)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button onClick={() => { const el = document.createElement('div'); el.innerHTML = '<strong>🎁 Royal Bridal Package Includes:</strong><ul style="margin:5px 0 0 15px;padding:0;text-align:left;list-style-type:disc;"><li>HD Airbrush Makeup</li><li>Hairstyling & Draping</li><li>Trial Session Included</li><li>Premium Products Only</li></ul>'; el.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:var(--sidebar-bg);color:#fff;padding:12px 24px;border-radius:var(--radius-sm);font-family:var(--font-btn);font-size:0.78rem;z-index:2000;box-shadow:0 8px 24px rgba(0,0,0,0.2);line-height:1.4;'; document.body.appendChild(el); setTimeout(() => el.remove(), 4000); }} style={{ background: 'none', border: 'none', color: 'var(--maroon-btn)', fontSize: '0.68rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-btn)' }}>View Details</button>
              </div>
            </div>
